            ...
            <div class="bg-gray-100 dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 animate-slide-up">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 px-6 py-5 border-b border-gray-200 dark:border-gray-600">
                    <div class="flex items-center">
                        ...
                        <h3 class="ml-4 text-lg font-semibold text-gray-800 dark:text-gray-100">Form Tambah Layanan</h3>
                    </div>
                </div>
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.services.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="judul" class="block mt-1 w-full border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="text" name="judul" :value="old('judul')" required autofocus />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="subjudul" :value="__('Subjudul (Opsional)')" class="text-gray-700 dark:text-gray-300" />
                            <x-text-input id="subjudul" class="block mt-1 w-full border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="text" name="subjudul" :value="old('subjudul')" />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="harga" :value="__('Harga (Hanya Angka, cth: 500000)')" class="text-gray-700 dark:text-gray-300" />
                            <x-text-input id="harga" class="block mt-1 w-full border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="number" name="harga" :value="old('harga')" required />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="deskripsi" :value="__('Deskripsi')" class="text-black dark:text-gray-300" />
                            <textarea id="deskripsi" name="deskripsi" rows="5" class="block mt-1 w-full border-gray-700 bg-gray-900 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('deskripsi') }}</textarea>
                        </div>

                        <div class="mb-6">
                            <label for="is_favorite" class="inline-flex items-center">
                                <input id="is_favorite" type="checkbox" name="is_favorite" value="1" class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 shadow-sm focus:ring-indigo-500">
