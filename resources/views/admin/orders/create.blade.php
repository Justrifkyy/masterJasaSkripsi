                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.orders.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="harga_pesanan" class="block mt-1 w-full" type="number" name="harga_pesanan" :value="old('harga_pesanan')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status" name="status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                <option value="wa_pending" @selected(old('status', $order->status ?? '') == 'wa_pending')>Pending WA (Belum Deal)</option> <option value="pending" @selected(old('status', $order->status ?? '') == 'pending')>Pending (Menunggu Pembayaran)</option> <option value="diproses" @selected(old('status', $order->status ?? '') == 'diproses')>Diproses</option>
